local Translations = {
    error = {
        ...
        not_whitelisted = 'U staat niet op de whitelist voor deze server'
    },
    success = {},
    info = {
        ...
        checking_ban = 'Hallo %s. We controleren of je een ban hebt.',
        join_server = 'Welkom %s in {Server Name}.',
        checking_whitelisted = 'Hallo %s. We controleren uw toegang.'
    }
}
